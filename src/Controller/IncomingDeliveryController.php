...
//incoming
    ...
    /**
     * @Route("/deliveries/incoming", name="incomingDelivery_all")
     */
    public function index()
    {
//        Get all Incoming Deliveries
        $incomingDeliveries = $this->getDoctrine()->getRepository(IncomingDeliveryController::class)->findAll();
...
//            get the submitted data
            ...
            $associatedProduct = $createdIncomingDelivery['product'];
